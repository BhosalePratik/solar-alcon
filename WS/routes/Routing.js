...
var loginService = require('../public/services/login');
...
routing.get('/gets', function(req, res, next) {
    let user = 'jatin.pawar@alpine.com';
    loginService.validateLogin(user).then(function (allocations) {
